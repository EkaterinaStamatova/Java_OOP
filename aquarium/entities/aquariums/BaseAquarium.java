...
public class BaseAquarium implements Aquarium{
    ...
    public String getInfo() {
        ...
        String names;
        boolean isFishAquariumEmpty = this.fish.isEmpty();
        if(!isFishAquariumEmpty){
            names = this.fish.stream()
                    .map(Fish::getName)
        ...
        sb.append(String.format("Fish: %s%n", names));
